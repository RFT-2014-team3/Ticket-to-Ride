...
public enum Route {
	...
	SAN_FRANCISCO__SALT_LAKE_CITY(City.SAN_FRANCISCO, City.SALT_LAKE_CITY, 5, TrainColor.ORANGE, TrainColor.WHITE),
	SAN_FRANCISCO__LOS_ANGELES(City.SAN_FRANCISCO, City.LOS_ANGELES, 3, TrainColor.YELLOW, TrainColor.PURPLE),
	LOS_ANGELES__LAS_VEGAS(City.LOS_ANGELES, City.LAS_VEGAS, 2, TrainColor.GREY),
	...
	LAS_VEGAS__SALT_LAKE_CITY(City.LAS_VEGAS, City.SALT_LAKE_CITY, 3, TrainColor.ORANGE),
	SALT_LAKE_CITY__DENVER(City.SALT_LAKE_CITY, City.DENVER, 3, TrainColor.RED, TrainColor.YELLOW),
	SALT_LAKE_CITY__HELENA(City.SALT_LAKE_CITY, City.HELENA, 3, TrainColor.PURPLE),
	...
	SANTA_FE__EL_PASO(City.SANTA_FE, City.EL_PASO, 2, TrainColor.GREY),
	...
	DENVER__OMAHA(City.DENVER, City.OMAHA, 4, TrainColor.PURPLE),
	...
	OKLAHOMA_CITY__DALLAS(City.OKLAHOMA_CITY, City.DALLAS, 2, TrainColor.GREY, TrainColor.GREY),
	...
	MONTREAL__TORONTO(City.MONTREAL, City.TORONTO, 3, TrainColor.GREY),
	TORONTO__CHICAGO(City.TORONTO, City.CHICAGO, 4, TrainColor.WHITE),
	...
	TORONTO__PITTSBURGH(City.TORONTO, City.PITTSBURGH, 2, TrainColor.GREY),
	...
	NEW_YORK__PITTSBURGH(City.NEW_YORK, City.PITTSBURGH, 2, TrainColor.WHITE, TrainColor.GREEN),
	PITTSBURGH__NASHVILLE(City.PITTSBURGH, City.NASHVILLE, 4, TrainColor.YELLOW),
	...
	NEW_YORK__WASHINGTON(City.NEW_YORK, City.WASHINGTON, 2, TrainColor.ORANGE, TrainColor.BLACK),
	WASHINGTON__RALEIGH(City.WASHINGTON, City.RALEIGH, 2, TrainColor.GREY, TrainColor.GREY),
	RALEIGH__ATLANTA(City.RALEIGH, City.ATLANTA, 2, TrainColor.GREY, TrainColor.GREY),
	RALEIGH__CHARLESTON(City.RALEIGH, City.CHARLESTON, 2, TrainColor.GREY),
	...
	CHARLESTON__MIAMI(City.CHARLESTON, City.MIAMI, 4, TrainColor.PURPLE);
